...
public class DegreeAnalysisTest {
    ...
    public void degreeAnalysis_test_牌级别判定() throws Exception{
        ...
        assertEquals(new GroupDegreeAnalysis().getDegree(list1), 8);
        ...
        assertEquals(new GroupDegreeAnalysis().getDegree(list2), 7);
        ...
        assertEquals(new GroupDegreeAnalysis().getDegree(list3), 6);
        ...
        assertEquals(new GroupDegreeAnalysis().getDegree(list4), 5);
        ...
        assertEquals(new GroupDegreeAnalysis().getDegree(list5), 4);
        ...
        assertEquals(new GroupDegreeAnalysis().getDegree(list6), 3);
        ...
        assertEquals(new GroupDegreeAnalysis().getDegree(list7), 2);
        ...
        assertEquals(new GroupDegreeAnalysis().getDegree(list8), 1);
        ...
        assertEquals(new GroupDegreeAnalysis().getDegree(list9), 0);
    }
}
